@echo off
:: ===============================================================
:: remove_vmware_drivers.cmd
:: Remove all VMware-related PnP devices using devcon.exe
...
echo.
echo ===============================================================
echo   Remove VMware Drivers Script (Interactive)
...
REM choice /m "Proceed to review and remove these devices?"
REM if errorlevel 2 (
...
:: --- Subroutine: confirm and remove one device ---
:RemoveDevice
setlocal enabledelayedexpansion
set "DEVID=!DEVID:~0!"
...
echo ---------------------------------------------------------------
REM
REM choice /m "Remove this device?"
REM if errorlevel 2 (
